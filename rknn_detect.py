...
import warnings
warnings.simplefilter(action='ignore' , category=FutureWarning)  # 关闭烦人的tensorflow的FutureWarning
...
if __name__ == '__main__':
    ...
    input0_data = input0_data.reshape([3, 80, 80, 6])
    input1_data = input1_data.reshape([3, 40, 40, 6])
    input2_data = input2_data.reshape([3, 20, 20, 6])
